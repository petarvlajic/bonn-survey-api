  ...
  const pdf = await buildFinalConsentEmailPdf(
    {
      ...
      pid: 'PID-12345',
      answers: [
        { questionId: 'name', value: 'Anna Testpatientin' },
        { questionId: 'email', value: 'anna.test@example.com' },
        { questionId: 'birthDate', value: '1990-05-15' },
        { questionId: 'date', value: '2026-05-20' },
        { questionId: 'hasChestComplaints', value: 'Ja' },
        { questionId: 'painType', value: 'Druckgefühl' },
        { questionId: 'complaintsSince', value: '2 Wochen' },
        { questionId: 'painIntensity', value: '5' },
        { questionId: 'breathlessnessOnExertion', value: 'Nein' },
        { questionId: 'palpitations', value: 'Ja, gelegentlich' },
        {
          questionId: 'heartDiseases',
          type: 'MULTIPLE_CHOICE',
          value: ['Hypertonie', 'Keine bekannt'],
        },
        { questionId: 'riskFactors', value: 'Rauchen (früher)' },
        { questionId: 'echoFreeText', value: 'Echo vor 2 Jahren, unauffällig.' },
        {
